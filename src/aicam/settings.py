...
BASE_URL = Knob(env_name="BASE_URL", default='https://w1b3ba0lw6.execute-api.us-east-1.amazonaws.com', description="Base URL to send HTTP post to")
...
SECRET_KEY = Knob(env_name="AWS_SECRET_ACCESS_KEY", default=False, description="AWS Access Key")

MIN_PREDICT_SCORE = Knob(env_name="MIN_PREDICT_SCORE", default=0.5, description="AWS Access Key")
